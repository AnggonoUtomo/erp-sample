...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('hr_onboarding_template_items', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['onboarding_template_id', 'sort_order'], 'hr_onboarding_template_items_order_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('hr_onboarding_template_items');
