...
const shortcuts = [
    { keys: 'Ctrl/Cmd + Shift + A', label: 'Tambah Employment Status' },
    ...
    { keys: 'Delete', label: 'Arsipkan Employment Status terpilih' },
    { keys: 'Esc', label: 'Keluar dari mode form' },
];

export function EmploymentStatusShortcutPanel() {
    return (
                ...
                <CollapsibleTrigger className="group flex w-full items-center justify-between gap-3 p-4 text-left">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Perintah cepat untuk mengelola Employment Status.</p>
                        </div>
                    </div>
