    ...
    return (
        <div className="w-full min-w-0 space-y-4">
            <div className="space-y-2.5">
                <div className="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-0.5 text-sm">Cari, filter, dan kelola master jabatan per departement.</p>
                    </div>
                                    ...
                                    <td className="px-2.5 py-2.5">
                                        {row.departement ? (
                                            <div className="min-w-0">
                                                ...
                                                <div className="text-muted-foreground truncate text-xs">Kode departement: {row.departement.code}</div>
                                            </div>
                                        ) : (
                                            <div className="min-w-0">
                                                <div className="truncate font-medium">Belum terhubung</div>
                                                <div className="text-muted-foreground truncate text-xs">Pilih departement pada form</div>
                                            </div>
                                        )}
                                    </td>
                                    <td className="px-2.5 py-2.5">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <PaginationBar meta={positions} routeName="hr.positions.index" filters={{ search, status, departement }} idPrefix="positions" />
            </div>
        </div>
    );
}
