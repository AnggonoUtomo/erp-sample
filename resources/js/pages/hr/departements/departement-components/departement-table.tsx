    ...
    return (
        <div className="w-full min-w-0 space-y-4">
            <div className="space-y-2.5">
                <div className="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p className="mt-0.5 text-sm text-muted-foreground">Cari, filter, dan kelola struktur unit organisasi HR.</p>
                    </div>
                                    ...
                                    <td className="px-2.5 py-2.5">
                                        {row.parent ? (
                                            <div className="min-w-0">
                                                ...
                                                <div className="truncate text-xs text-muted-foreground">Kode parent: {row.parent.code}</div>
                                            </div>
                                        ) : (
                                            <div className="min-w-0">
                                                <div className="truncate font-medium">Root departement</div>
                                                <div className="truncate text-xs text-muted-foreground">Tidak punya parent</div>
                                            </div>
                                        )}
                                    </td>
                                    <td className="px-2.5 py-2.5">
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <PaginationBar
                    meta={departements}
                    routeName="hr.departements.index"
                    filters={{ search, status }}
                    idPrefix="departements"
                />
            </div>
        </div>
    );
