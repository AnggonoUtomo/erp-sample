...
const shortcuts = [
    { keys: 'Ctrl/Cmd + Shift + A', label: 'Tambah reference data' },
    { keys: 'Ctrl/Cmd + K atau /', label: 'Fokus pencarian' },
    { keys: 'Alt + C', label: 'Fokus kategori' },
    ...
    { keys: 'Delete', label: 'Arsipkan reference data terpilih' },
    { keys: 'Esc', label: 'Keluar dari mode form' },
];

export function HRReferenceDataShortcutPanel() {
    return (
                ...
                <CollapsibleTrigger className="group flex w-full items-center justify-between gap-3 p-4 text-left">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-xs">Perintah cepat untuk mengelola HR Reference Data.</p>
                        </div>
                    </div>
