        ...
        <Card data-dashboard-card className="overflow-hidden">
            <CardHeader className="space-y-4 border-b">
                <CardTitle className="flex items-center gap-2 text-lg">
                    ...
                    {isEdit ? 'Edit Organization Structure' : 'Tambah Organization Structure'}
                </CardTitle>
                <p className="text-muted-foreground text-sm">Field bertanda bintang wajib diisi. Relasi parent dipakai untuk membentuk hierarchy.</p>
            </CardHeader>
            <CardContent className="p-5">
                <OrganizationStructureForm
                    form={props.form}
                    editing={isEdit ? props.organizationStructure : null}
                    parentOptions={props.parentOptions}
                    departementOptions={props.departementOptions}
                    positionOptions={props.positionOptions}
                    nodeTypeOptions={props.nodeTypeOptions}
