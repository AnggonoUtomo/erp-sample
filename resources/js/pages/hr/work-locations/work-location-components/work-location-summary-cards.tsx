...
import { ArchiveRestore, MapPin, ToggleLeft, ToggleRight } from 'lucide-react';
import type { WorkLocationSummary } from '../types';
...
const cards = [
    { key: 'total', label: 'Total lokasi', icon: MapPin, tone: 'icon-tone-sky' },
...
export function WorkLocationSummaryCards({ summary }: Props) {
    return (
