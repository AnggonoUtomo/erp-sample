...
const shortcuts = [
    { keys: 'Ctrl/Cmd + Shift + A', label: 'Tambah job level' },
    ...
    { keys: 'Delete', label: 'Arsipkan job level terpilih' },
    { keys: 'Esc', label: 'Keluar dari mode form' },
];

export function JobLevelShortcutPanel() {
    return (
                ...
                <CollapsibleTrigger className="group flex w-full items-center justify-between gap-3 p-4 text-left">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-xs">Perintah cepat untuk mengelola job level.</p>
                        </div>
                    </div>
