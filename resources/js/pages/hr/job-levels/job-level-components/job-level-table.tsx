    ...
    return (
        <div className="w-full min-w-0 space-y-4">
            <div className="space-y-2.5">
                <div className="flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-0.5 text-sm">Cari, filter, dan kelola grade jabatan HR.</p>
                    </div>
                                ...
                                <tr key={row.id} className="hover:bg-muted/40 border-t transition">
                                    ...
                                    <td className="px-2.5 py-2.5">
                                        <div className="min-w-0">
                                            ...
                                            <div className="text-muted-foreground truncate text-xs">Referensi employee dan payroll</div>
                                        </div>
                                    </td>
                                    <td className="px-2.5 py-2.5">
                                        {row.deleted_at ? (
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <PaginationBar meta={jobLevels} routeName="hr.job-levels.index" filters={{ search, status, archive }} idPrefix="job-levels" />
            </div>
        </div>
    );
}
