...
const shortcuts = [
    { keys: 'Ctrl/Cmd + Shift + A', label: 'Tambah Employment Type' },
    ...
    { keys: 'Delete', label: 'Arsipkan Employment Type terpilih' },
    { keys: 'Esc', label: 'Keluar dari mode form' },
];

export function EmploymentTypeShortcutPanel() {
    return (
                ...
                <CollapsibleTrigger className="group flex w-full items-center justify-between gap-3 p-4 text-left">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-xs">Perintah cepat untuk mengelola Employment Type.</p>
                        </div>
                    </div>
