                            ...
                            <CardContent className="p-5 sm:p-6">
                                                ...
                                                <div className="grid gap-2 text-sm">
                                                    <div className="flex items-center justify-between gap-3">
                                                        ...
                                                        <Badge variant={emailSettings.enabled ? 'default' : 'secondary'}>
                                                            {boolLabel(emailSettings.enabled)}
                                                        </Badge>
                                                    </div>
                                                    <div className="flex items-center justify-between gap-3">
                                                ...
                                                <div className="grid gap-2 text-sm">
                                                    ...
                                                    <div className="flex items-center justify-between gap-3">
                                                        ...
                                                        <Badge variant="secondary">
                                                            {boolLabel(emailSettings.send_credentials_on_password_update)}
                                                        </Badge>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <form onSubmit={submitTestEmail} className="bg-background/60 mb-8 rounded-lg border p-4">
                                    ...
                                    <p className="text-muted-foreground mt-3 text-xs leading-relaxed">
                                        Test memakai konfigurasi email yang sudah tersimpan. Simpan perubahan SMTP terlebih dahulu sebelum menekan
                                        tombol ini.
                                    </p>
                                </form>
                                    ...
                                    <section className="space-y-4">
                                        <div className="grid gap-4 md:grid-cols-2">
                                            ...
                                            <div className="space-y-2">
                                                <FieldInfoLabel
                                                    required
                                                    description="Gunakan SMTP untuk email sungguhan, log/array untuk development."
                                                >
                                                    Mailer
                                                </FieldInfoLabel>
                                                <Select
                                        ...
                                        <div className="grid gap-4 md:grid-cols-2">
                                            ...
                                            <div className="space-y-2">
                                                <FieldInfoLabel
                                                    htmlFor="port"
                                                    required={mailerUsesSmtp}
                                                    description="Port umum SMTP adalah 587, 465, atau 2525."
                                                >
                                                    SMTP Port
                                                </FieldInfoLabel>
                                                <Input
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    disabled={!can.update || !mailerUsesSmtp}
                                                    placeholder={
                                                        emailSettings.password_configured ? 'Password sudah tersimpan' : 'Masukkan password SMTP'
                                                    }
                                        ...
                                        <div className="grid gap-4 md:grid-cols-2">
                                            <div className="space-y-2">
                                                <FieldInfoLabel
                                                    ...
                                                    required
                                                    description="Alamat email pengirim yang terlihat oleh penerima."
                                                >
                                                    From Address
                                                </FieldInfoLabel>
                                                <Input
                                            ...
                                            <div className="space-y-2">
                                                <FieldInfoLabel
                                                    htmlFor="from_name"
                                                    required
                                                    description="Nama pengirim yang tampil di inbox penerima."
                                                >
                                                    From Name
                                                </FieldInfoLabel>
                                                <Input
                                    ...
                                    <section className="space-y-4">
                                        <div className="grid gap-4 md:grid-cols-2">
                                            <label className="bg-background/60 flex items-start gap-3 rounded-lg border p-4">
                                                ...
                                                <span>
                                                    ...
                                                    <span className="text-muted-foreground mt-1 block text-xs leading-relaxed">
                                                        User menerima email berisi tautan untuk aktivasi akun dan mengatur password melalui queue
                                                        mail.
                                                    </span>
                                                </span>
                                            </label>
                                            ...
                                            <label className="bg-background/60 flex items-start gap-3 rounded-lg border p-4">
                                                <Checkbox
                                                    ...
                                                    onCheckedChange={(checked) =>
                                                        form.setData('send_credentials_on_password_update', Boolean(checked))
                                                    }
                                                />
                                                <span>
                                                    <span className="block text-sm font-medium">Izinkan tautan atur password dari edit user</span>
                                                    <span className="text-muted-foreground mt-1 block text-xs leading-relaxed">
                                                        Email diproses via queue mail saat admin mencentang kirim tautan atur password pada edit
                                                        user.
                                                    </span>
                                                </span>
                                            </label>
                                        ...
                                        <div className="space-y-2">
                                            <FieldInfoLabel
                                                ...
                                                description="Kalimat pembuka sebelum tombol aktivasi dan atur password."
                                            >
