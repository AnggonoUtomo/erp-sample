...
| Risiko | Mitigasi |
|---|---|
| position dipindah departement secara retroaktif; delete saat direferensikan; code collision | Restrict/guard mutation, transaction, audit, dan regression tests |
