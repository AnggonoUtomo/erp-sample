...
**Files:** `app/Modules/HR/Positions/module.php`, `routes.php`, `permissions.php`, migration/model, tests, docs.
...
- [ ] Invariant position memiliki regression test.

**Test:** `php artisan test --filter=HRPosition`. **Dependency:** Task 01. **Scope:** M.
