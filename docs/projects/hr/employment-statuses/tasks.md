...
**Files:** `app/Modules/HR/EmploymentStatuses/module.php`, `routes.php`, `permissions.php`, migration/model, tests, docs.
...
- [ ] Invariant employment status memiliki regression test.

**Test:** `php artisan test --filter=HREmploymentStatus`. **Dependency:** Task 01. **Scope:** M.
