# Implementation Plan: Job Levels
...
| Risiko | Mitigasi |
|---|---|
| urutan level ambigu; penghapusan grade yang direferensikan; pencampuran grade dan position | Restrict/guard mutation, transaction, audit, dan regression tests |
