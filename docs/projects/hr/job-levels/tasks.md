...
**Files:** `app/Modules/HR/JobLevels/module.php`, `routes.php`, `permissions.php`, migration/model, tests, docs.
...
- [ ] Invariant job level memiliki regression test.

**Test:** `php artisan test --filter=HRJobLevel`. **Dependency:** Task 01. **Scope:** M.
