...
**Files:** `app/Modules/HR/Departements/module.php`, `routes.php`, `permissions.php`, migration/model, tests, docs.
...
- [ ] Invariant departement memiliki regression test.

**Test:** `php artisan test --filter=HRDepartement`. **Dependency:** Task 01. **Scope:** M.
