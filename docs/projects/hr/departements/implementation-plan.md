# Implementation Plan: Departements
...
| Risiko | Mitigasi |
|---|---|
| penghapusan master yang masih direferensikan; perubahan kode setelah dipakai downstream | Restrict/guard mutation, transaction, audit, dan regression tests |
