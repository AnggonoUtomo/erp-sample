# Implementation Plan: Employment Types
...
| Risiko | Mitigasi |
|---|---|
| flag berubah retroaktif; kontrak tanpa end date untuk tipe yang mewajibkannya | Restrict/guard mutation, transaction, audit, dan regression tests |
