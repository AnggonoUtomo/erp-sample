...
**Files:** `app/Modules/HR/WorkLocations/module.php`, `routes.php`, `permissions.php`, migration/model, tests, docs.
...
- [ ] Invariant work location memiliki regression test.

**Test:** `php artisan test --filter=HRWorkLocation`. **Dependency:** Task 01. **Scope:** M.
