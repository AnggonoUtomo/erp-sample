...
**Files:** `app/Modules/HR/HRReferenceData/module.php`, `routes.php`, `permissions.php`, migration/model, tests, docs.
...
- [ ] Invariant reference category dan reference item memiliki regression test.

**Test:** `php artisan test --filter=HRReferenceData`. **Dependency:** Task 01. **Scope:** M.
