# Implementation Plan: HR Reference Data
...
| Risiko | Mitigasi |
|---|---|
| category/code diubah setelah dipakai; metadata tanpa schema; duplikasi master khusus | Restrict/guard mutation, transaction, audit, dan regression tests |
