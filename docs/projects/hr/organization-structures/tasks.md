...
**Files:** `app/Modules/HR/OrganizationStructures/module.php`, `routes.php`, `permissions.php`, migration/model, tests, docs.
...
- [ ] Invariant organization node memiliki regression test.

**Test:** `php artisan test --filter=HROrganizationStructure`. **Dependency:** Task 01. **Scope:** M.
