...
**Files:** `app/Modules/HR/Employees/module.php`, `routes.php`, `permissions.php`, migration/model, tests, docs.
...
- [ ] Invariant employee memiliki regression test.

**Test:** `php artisan test --filter=HREmployeeTest`. **Dependency:** Task 01. **Scope:** M.
