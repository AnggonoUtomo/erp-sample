...
| Risiko | Mitigasi |
|---|---|
| PII exposure; duplicate national/employee identity; direct assignment edit bypassing movement history | Restrict/guard mutation, transaction, audit, dan regression tests |
