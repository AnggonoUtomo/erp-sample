...
16. Evaluasi integration event hanya jika consumer nyata tersedia. Hasil 2026-07-17: gate approved dan `EmployeeOffboardingCompletedV1` dipublikasikan minimal; lihat [ADR-004](decisions/004-defer-integration-event-v1.md).
...
- Public event baru diterbitkan setelah schema dan consumer gate disetujui.
