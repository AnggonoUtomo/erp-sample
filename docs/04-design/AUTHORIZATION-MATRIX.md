...
Interface aktif adalah web/session. Policy Laravel/Spatie mengadaptasi permission user ke operasi controller dan ditempatkan pada target `Presentation/Policies/`; policy tersebut bukan aturan domain murni.
